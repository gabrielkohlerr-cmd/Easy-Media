...
- `js/photo-art.js`: gera as "vitrines" em SVG usadas quando um carro não tem fotos reais.
...
Cada carro pode usar fotos reais ou, na ausência delas, cai numa vitrine
gerada em SVG (silhueta dourada). Para adicionar fotos reais a um carro:

1. Coloque as fotos em `assets/carros/<id-do-carro>/1.jpg`, `2.jpg` etc.
2. Em `js/cars.js`, adicione ao carro os campos `fotos: ["assets/carros/.../1.jpg", ...]`
   e `fotoLabels: ["Frontal", "Traseira", ...]` (um rótulo por foto).
